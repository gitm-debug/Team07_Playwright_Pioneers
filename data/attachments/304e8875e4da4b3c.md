            ...
            - gridcell [ref=f1e48]:
              - generic [ref=f1e50] [cursor=pointer]:
                - generic [ref=f1e51]:
                  - checkbox
                - checkbox [ref=f1e52]
            - gridcell "BatchFor-Program" [ref=f1e53]
            - gridcell "Updated yhmojein" [ref=f1e54]
            ...
            - gridcell [ref=f1e56]:
              - generic [ref=f1e58]:
                ...
                - button [ref=f1e61] [cursor=pointer]:
                  - generic [ref=f1e62]: 
      - generic [ref=f1e64]:
        - generic [ref=f1e65] [cursor=pointer]: Showing 1 to 1 of 1 entries
        - button "" [disabled]
        - button "" [disabled]
        - button "1" [ref=f1e67] [cursor=pointer]
        - button "" [disabled]
        - button "" [disabled]
      - generic [ref=f1e68]: In total there are 1 programs.
```
