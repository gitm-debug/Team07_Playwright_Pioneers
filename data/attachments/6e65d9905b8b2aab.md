  ...
  - rowgroup:
    ...
    - row "TeamLMS_996 Batch Description001 Active 4 Updatedhbhbvz":
      ...
      - gridcell:
        - button
        - button
    - row "TeamLMS_997 Batch Description001 Active 4 Updatedhbhbvz":
      - gridcell:
        - checkbox
        - checkbox
      - gridcell "TeamLMS_997"
      - gridcell "Batch Description001"
      - gridcell "Active"
      - gridcell "4"
      - gridcell "Updatedhbhbvz"
      - gridcell:
        - button
        - button
    - row "TeamLMS_999 Batch Description001 Active 4 Updatedhbhbvz":
      - gridcell:
        - checkbox
        - checkbox
      - gridcell "TeamLMS_999"
      - gridcell "Batch Description001"
      - gridcell "Active"
      - gridcell "4"
      - gridcell "Updatedhbhbvz"
      - gridcell:
        - button
        - button
    - row "Updatedcpvzv_66867 Active 2 Updatedcpvzv":
      - gridcell:
        - checkbox
        - checkbox
      - gridcell "Updatedcpvzv_66867"
      - gridcell
      - gridcell "Active"
      - gridcell "2"
      - gridcell "Updatedcpvzv"
      - gridcell:
        - button
        - button
...
- button ""
- button ""
- text: In total there are 12 batches.
```
