...
```
Error: Program not found: Program "Updatedpegtiy" not found in search results
```
  ...
  - generic [ref=e13]:
    - generic [ref=e14]:
      ...
      - generic [ref=e16]:
        ...
        - generic [ref=e21]:
          - generic [ref=e22]: 
          - textbox "Search..." [active] [ref=e23]: Updatedpegtiy
    - generic [ref=e26]:
      - grid [ref=e28]:
        - rowgroup [ref=e29]:
          - row [ref=e30]:
      ...
      - generic [ref=e47]:
        ...
        - button "" [disabled]
        - button "" [disabled]
      - generic [ref=e51]: In total there are 14 programs.
```
