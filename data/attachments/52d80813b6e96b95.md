  ...
  - rowgroup:
    ...
    - row "Seedyhappyprog_19377 Seed batch Active 5 Seedyhappyprog":
      ...
      - gridcell:
        - button
        - button
    - row "Seedyhappyprog_19932 Seed batch Active 5 Seedyhappyprog":
      - gridcell:
        - checkbox
        - checkbox
      - gridcell "Seedyhappyprog_19932"
      - gridcell "Seed batch"
      - gridcell "Active"
      - gridcell "5"
      - gridcell "Seedyhappyprog"
      - gridcell:
        - button
        - button
    - row "Seedyhappyprog_21234 Seed batch Active 5 Seedyhappyprog":
      - gridcell:
        - checkbox
        - checkbox
      - gridcell "Seedyhappyprog_21234"
      - gridcell "Seed batch"
      - gridcell "Active"
      - gridcell "5"
      - gridcell "Seedyhappyprog"
      - gridcell:
        - button
        - button
- text: Showing 1 to 10 of 246 entries
- button "" [disabled]
- button "" [disabled]
- button "1"
- button "2"
...
- button ""
- button ""
- text: In total there are 246 batches.
```
