  ...
  - rowgroup:
    - row "BDDBrigade-TeamSIX_06297 Active 5 BDDBrigade-TeamSIX":
      ...
      - gridcell:
        - button
        - button
    - row "Programlbabreep_001 Active 5 Updatedagketd":
      - gridcell:
        - checkbox
        - checkbox
      - gridcell "Programlbabreep_001"
      - gridcell
      - gridcell "Active"
      - gridcell "5"
      ...
      - gridcell:
        - button
        - button
    - row "Programlbabreep_23677 Arrays and Loops Active 7 Updatedagketd":
      - gridcell:
        - checkbox
        - checkbox
      - gridcell "Programlbabreep_23677"
    ...
    - row "Programlbabreep_43193 Active 5 Updatedagketd":
      ...
      - gridcell:
        - button
        - button
    - row "Programlbabreep_62464 Active 5 Updatedagketd":
      - gridcell:
        - checkbox
        - checkbox
      - gridcell "Programlbabreep_62464"
      - gridcell
      - gridcell "Active"
      - gridcell "5"
      - gridcell "Updatedagketd"
    ...
    - row "Programqbgpahmf_25491 Arrays and Loops Active 7 Updatedexsqmm":
      ...
      - gridcell:
        - button
        - button
- text: Showing 1 to 10 of 16 entries
- button "" [disabled]
- button "" [disabled]
- button "1"
- button "2"
- button ""
- button ""
- text: In total there are 16 batches.
```
