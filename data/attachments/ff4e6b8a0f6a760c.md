            ...
            - gridcell [ref=f1e73]:
              - generic [ref=f1e75] [cursor=pointer]:
                - generic [ref=f1e76]:
                  - checkbox
                - checkbox [ref=f1e77]
            - gridcell "TeamSix-BDD_16839" [ref=f1e78]
            - gridcell [ref=f1e79]
            - gridcell "Active" [ref=f1e80]
            - gridcell "5" [ref=f1e81]
            - gridcell "TeamSix-BDD" [ref=f1e82]
            - gridcell [ref=f1e83]:
              - generic [ref=f1e84]:
            ...
            - gridcell [ref=f1e92]:
              - generic [ref=f1e94] [cursor=pointer]:
                - generic [ref=f1e95]:
                  - checkbox
                - checkbox [ref=f1e96]
            - gridcell "TeamSix-BDD_17562" [ref=f1e97]
            - gridcell "Arrays and Loops" [ref=f1e98]
            - gridcell "Active" [ref=f1e99]
            - gridcell "7" [ref=f1e100]
            - gridcell "TeamSix-BDD" [ref=f1e101]
            - gridcell [ref=f1e102]:
              - generic [ref=f1e103]:
            ...
            - gridcell [ref=f1e121]:
              - generic [ref=f1e122]:
                ...
                - button [ref=f1e127] [cursor=pointer]:
                  - generic [ref=f1e128]: 
      - generic [ref=f1e130]:
        - generic [ref=f1e131] [cursor=pointer]: Showing 11 to 14 of 14 entries
        - button "" [ref=f1e132] [cursor=pointer]
        - button "" [ref=f1e134] [cursor=pointer]
        - generic [ref=f1e136]:
          - button "1" [ref=f1e137] [cursor=pointer]
          - button "2" [ref=f1e138] [cursor=pointer]
        - button "" [disabled]
        - button "" [disabled]
      - generic [ref=f1e139]: In total there are 14 batches.
```
