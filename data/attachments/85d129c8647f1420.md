...
Call log:
  - waiting for locator('tbody tr').nth(2).locator('button:has(.pi-pencil)')
    - locator resolved to <button pbutton="" pripple="" icon="pi pi-pencil" _ngcontent-vpf-c140="" ng-reflect-icon="pi pi-pencil" class="p-button-rounded p-button-success p-button p-component p-button-icon-only">…</button>
  - attempting click action
    2 × waiting for element to be visible, enabled and stable
      - element is visible, enabled and stable
      - scrolling into view if needed
      - done scrolling
      - <div ng-reflect-ng-class="[object Object]" class="ng-tns-c81-4 p-dialog-mask p-component-overlay p-dialog-mask-scrollblocker ng-star-inserted">…</div> from <p-dialog styleclass="p-fluid" class="ng-tns-c81-4" _ngcontent-vpf-c140="" header="Batch Details" ng-reflect-modal="true" ng-reflect-visible="true" ng-reflect-style-class="p-fluid" ng-reflect-header="Batch Details">…</p-dialog> subtree intercepts pointer events
  ...
  - retrying click action
    ...
    - scrolling into view if needed
    - done scrolling
    - <p-toastitem ng-reflect-index="0" ng-reflect-message="[object Object]" ng-reflect-hide-transition-options="250ms ease-in" ng-reflect-show-transition-options="300ms ease-out" ng-reflect-show-transform-options="translateY(100%)" ng-reflect-hide-transform-options="translateY(-100%)" class="ng-tns-c20-9 ng-trigger ng-trigger-toastAnimation ng-tns-c21-3 ng-star-inserted">…</p-toastitem> from <p-toast class="ng-tns-c21-3" _ngcontent-vpf-c140="">…</p-toast> subtree intercepts pointer events
  - retrying click action
    - waiting 100ms
    - waiting for element to be visible, enabled and stable
