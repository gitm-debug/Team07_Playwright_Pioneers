  ...
  - rowgroup:
    - row "BDDTeamLMS_003 Active 4 BDDTeamLMS":
      ...
      - gridcell:
        - button
        - button
    - row "BDDTeamLMS_997 Batch Description002 Active 4 BDDTeamLMS":
      - gridcell:
        - checkbox
        - checkbox
      - gridcell "BDDTeamLMS_997"
      - gridcell "Batch Description002"
      - gridcell "Active"
      - gridcell "4"
      - gridcell "BDDTeamLMS"
      - gridcell:
        - button
        - button
    - row "CypressLMSApplication_44108 welcome Active 10 CypressLMSApplication":
      - gridcell:
        - checkbox
        - checkbox
    ...
    - row "CypressLMSApplication_44213 Active 9 CypressLMSApplication":
      ...
      - gridcell:
        - button
        - button
- text: Showing 1 to 10 of 143 entries
- button "" [disabled]
- button "" [disabled]
- button "1"
- button "2"
...
- button ""
- button ""
- text: In total there are 143 batches.
```
