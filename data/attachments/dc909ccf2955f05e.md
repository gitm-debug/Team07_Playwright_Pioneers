  ...
  - rowgroup:
    - row "Java-zzz_0033 Arrays and Loops Active 7 Updatedprdzmm":
      ...
      - gridcell:
        - button
        - button
    - row "Programekwemqx_0056 Active 5 Programekwemqx":
      - gridcell:
        - checkbox
        - checkbox
      - gridcell "Programekwemqx_0056"
      - gridcell
      - gridcell "Active"
      - gridcell "5"
      - gridcell "Programekwemqx"
      - gridcell:
        - button
        - button
    - row "Programfsgcczln_98070 aaaaaaaaaaaaaaaaaaaaaaaa Active 4 Programfsgcczln":
      - gridcell:
        - checkbox
        - checkbox
      - gridcell "Programfsgcczln_98070"
      - gridcell "aaaaaaaaaaaaaaaaaaaaaaaa"
      - gridcell "Active"
      - gridcell "4"
      - gridcell "Programfsgcczln"
      - gridcell:
        - button
        - button
    ...
    - row "Programyayauxyz_666 Active 5 Programyayauxyz":
      ...
      - gridcell:
        - button
        - button
    - row "Python_0003 Active 5 Python":
      - gridcell:
        - checkbox
        - checkbox
      - gridcell "Python_0003"
      - gridcell
      - gridcell "Active"
      - gridcell "5"
      - gridcell "Python"
...
- button ""
- button ""
- text: In total there are 25 batches.
```
