...
Call log:
  - waiting for locator('tbody tr').nth(5).locator('button:has(.pi-trash)')
    - locator resolved to <button pbutton="" pripple="" icon="pi pi-trash" _ngcontent-nwq-c140="" ng-reflect-icon="pi pi-trash" class="p-button-rounded p-button-danger p-button p-component p-button-icon-only">…</button>
  - attempting click action
    2 × waiting for element to be visible, enabled and stable
      - element is visible, enabled and stable
      - scrolling into view if needed
      - done scrolling
      - <div ng-reflect-ng-class="[object Object]" class="ng-tns-c118-6 ng-star-inserted p-dialog-mask p-component-overlay p-dialog-mask-scrollblocker">…</div> from <p-confirmdialog class="ng-tns-c118-6" _ngcontent-nwq-c140="">…</p-confirmdialog> subtree intercepts pointer events
