...
- grid:
  ...
  - rowgroup:
    - row "cloud-zzz_0033 Arrays and Loops Active 7 cloud-zzz":
      - gridcell:
        - checkbox
        - checkbox
      - gridcell "cloud-zzz_0033"
    ...
    - row "Programyayauxyz_27420 Active 9 Programyayauxyz":
      ...
      - gridcell:
        - button
        - button
    - row "Programyayauxyz_45048 Active 9 Programyayauxyz":
      - gridcell:
        - checkbox
        - checkbox
      - gridcell "Programyayauxyz_45048"
      - gridcell
      - gridcell "Active"
      - gridcell "9"
      - gridcell "Programyayauxyz"
    ...
    - row "Programyayauxyz_666 Active 5 Programyayauxyz":
      ...
      - gridcell:
        - button
        - button
    - row "Python_0002 Arrays and Loops Active 7 Python":
      - gridcell:
        - checkbox
        - checkbox
      - gridcell "Python_0002"
      - gridcell "Arrays and Loops"
      - gridcell "Active"
      - gridcell "7"
      - gridcell "Python"
    ...
    - row "Python_003 Active 5 Python":
      ...
      - gridcell:
        - button
        - button
- text: Showing 1 to 10 of 26 entries
- button "" [disabled]
- button "" [disabled]
- button "1"
- button "2"
...
- button ""
- button ""
- text: In total there are 26 batches.
```
