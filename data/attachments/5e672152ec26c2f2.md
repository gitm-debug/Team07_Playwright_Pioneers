            ...
            - gridcell [ref=f1e216]:
              - generic [ref=f1e217]:
                ...
                - button [ref=f1e222] [cursor=pointer]:
                  - generic [ref=f1e223]: 
      - generic [ref=f1e225]:
        - generic [ref=f1e226] [cursor=pointer]: Showing 11 to 19 of 19 entries
        - button "" [ref=f1e227] [cursor=pointer]
        - button "" [ref=f1e229] [cursor=pointer]
        - generic [ref=f1e231]:
          - button "1" [ref=f1e232] [cursor=pointer]
          - button "2" [ref=f1e233] [cursor=pointer]
        - button "" [disabled]
        - button "" [disabled]
      - generic [ref=f1e234]: In total there are 19 batches.
```
