  ...
  - rowgroup:
    - row "BatchesProgram_0033 Arrays and Loops Active 7 BatchesProgram":
      ...
      - gridcell:
        - button
        - button
    - row "BDDBrigade-TeamSIX_06297 Active 5 BDDBrigade-TeamSIX":
      - gridcell:
        - checkbox
        - checkbox
      - gridcell "BDDBrigade-TeamSIX_06297"
      - gridcell
      - gridcell "Active"
      - gridcell "5"
      - gridcell "BDDBrigade-TeamSIX"
      - gridcell:
        - button
        - button
    ...
    - row "Programqbgpahmf_25491 Arrays and Loops Active 7 Updatedexsqmm":
      ...
      - gridcell:
        - button
        - button
    - row "Programqbgpahmf_29624 Arrays and Loops Active 7 Updatedexsqmm":
      - gridcell:
        - checkbox
        - checkbox
      - gridcell "Programqbgpahmf_29624"
      - gridcell "Arrays and Loops"
      - gridcell "Active"
      - gridcell "7"
      - gridcell "Updatedexsqmm"
    ...
    - row "Programqbgpahmf_44777 Arrays and Loops Active 7 Updatedexsqmm":
      ...
      - gridcell:
        - button
        - button
    - row "TeamSix-BDD_10406 Seed batch Active 5 TeamSix-BDD":
      - gridcell:
        - checkbox
        - checkbox
      - gridcell "TeamSix-BDD_10406"
      - gridcell "Seed batch"
      - gridcell "Active"
      - gridcell "5"
      - gridcell "TeamSix-BDD"
      - gridcell:
        - button
        - button
- text: Showing 1 to 10 of 63 entries
- button "" [disabled]
- button "" [disabled]
- button "1"
- button "2"
...
- button ""
- button ""
- text: In total there are 63 batches.
```
