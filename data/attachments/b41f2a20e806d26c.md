  ...
  - rowgroup:
    - row "azure-nnznjy_111 Active 5 azure-nnznjy":
      ...
      - gridcell:
        - button
        - button
    - row "azure-nnznjy_987 Regular API class Active 20 azure-nnznjy":
      - gridcell:
        - checkbox
        - checkbox
      - gridcell "azure-nnznjy_987"
      - gridcell "Regular API class"
      - gridcell "Active"
      - gridcell "20"
      - gridcell "azure-nnznjy"
      - gridcell:
    ...
    - row "Seedyhappyprog_11322 Seed batch Active 5 Seedyhappyprog":
      ...
      - gridcell:
        - button
        - button
- text: Showing 1 to 10 of 256 entries
- button "" [disabled]
- button "" [disabled]
- button "1"
- button "2"
...
- button ""
- button ""
- text: In total there are 256 batches.
- dialog "Batch Details":
  ...
  - button
  - text: Batch Name *
  - textbox [disabled]: Seedyhappyprog_10059
  - text: Description
  - textbox "Description": Seed batch
  - text: "Status : *"
  - radio [checked]
  - text: Active
  - radio
  - text: Inactive Number of Classes *
  - spinbutton "Number of Classes *": "5"
  - button "Cancel"
  - button "Save"
```
