...
Call log:
  - waiting for locator('tbody tr').nth(4).locator('button:has(.pi-pencil)')
    - locator resolved to <button pbutton="" pripple="" icon="pi pi-pencil" _ngcontent-juc-c140="" ng-reflect-icon="pi pi-pencil" class="p-button-rounded p-button-success p-button p-component p-button-icon-only">…</button>
  - attempting click action
    2 × waiting for element to be visible, enabled and stable
      - element is visible, enabled and stable
      - scrolling into view if needed
      - done scrolling
      - <div ng-reflect-ng-class="[object Object]" class="ng-tns-c81-4 p-dialog-mask p-component-overlay p-dialog-mask-scrollblocker ng-star-inserted">…</div> from <p-dialog styleclass="p-fluid" class="ng-tns-c81-4" _ngcontent-juc-c140="" header="Batch Details" ng-reflect-modal="true" ng-reflect-visible="true" ng-reflect-style-class="p-fluid" ng-reflect-header="Batch Details">…</p-dialog> subtree intercepts pointer events
