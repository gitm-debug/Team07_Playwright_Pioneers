...
- grid:
  ...
  - rowgroup:
    - row "BatchesProgram_0033 Arrays and Loops Active 7 BatchesProgram":
      - gridcell:
        - checkbox
        - checkbox
      - gridcell "BatchesProgram_0033"
      - gridcell "Arrays and Loops"
      - gridcell "Active"
      - gridcell "7"
      - gridcell "BatchesProgram"
      - gridcell:
        - button
        - button
    - row "Programlbabreep_26135 Active 5 Updatedagketd":
      - gridcell:
        - checkbox
        - checkbox
      - gridcell "Programlbabreep_26135"
      - gridcell
      - gridcell "Active"
      - gridcell "5"
      - gridcell "Updatedagketd"
      - gridcell:
        - button
        - button
    - row "Programqbgpahmf_13392 api learning 123 Active 20 Updatedexsqmm":
      - gridcell:
        - checkbox
        - checkbox
      - gridcell "Programqbgpahmf_13392"
      - gridcell "api learning 123"
      - gridcell "Active"
      - gridcell "20"
      - gridcell "Updatedexsqmm"
      - gridcell:
        - button
        - button
    - row "Programqbgpahmf_24340 Active 5 Updatedexsqmm":
      - gridcell:
        - checkbox
        - checkbox
      - gridcell "Programqbgpahmf_24340"
      - gridcell
      - gridcell "Active"
      - gridcell "5"
      - gridcell "Updatedexsqmm"
      - gridcell:
        - button
        - button
    - row "Programqbgpahmf_25491 Arrays and Loops Active 7 Updatedexsqmm":
      - gridcell:
        - checkbox
        - checkbox
      - gridcell "Programqbgpahmf_25491"
      - gridcell "Arrays and Loops"
      - gridcell "Active"
      - gridcell "7"
      - gridcell "Updatedexsqmm"
      - gridcell:
        - button
        - button
    - row "Programqbgpahmf_33661 Active 5 Updatedexsqmm":
      - gridcell:
        - checkbox
        - checkbox
      - gridcell "Programqbgpahmf_33661"
      - gridcell
      - gridcell "Active"
      - gridcell "5"
      - gridcell "Updatedexsqmm"
      - gridcell:
        - button
        - button
    - row "Programqbgpahmf_44777 Arrays and Loops Active 7 Updatedexsqmm":
      - gridcell:
        - checkbox
        - checkbox
      - gridcell "Programqbgpahmf_44777"
      - gridcell "Arrays and Loops"
      - gridcell "Active"
      - gridcell "7"
      - gridcell "Updatedexsqmm"
      - gridcell:
        - button
        - button
    - row "Seedyhappyprog_0056 Arrays and Loops Active 7 Seedyhappyprog":
      - gridcell:
        - checkbox
        - checkbox
      - gridcell "Seedyhappyprog_0056"
      - gridcell "Arrays and Loops"
      - gridcell "Active"
      - gridcell "7"
      - gridcell "Seedyhappyprog"
      - gridcell:
        - button
        - button
    - row "Seedyhappyprog_10088 Seed batch Active 5 Seedyhappyprog":
      - gridcell:
        - checkbox
        - checkbox
      - gridcell "Seedyhappyprog_10088"
      - gridcell "Seed batch"
      - gridcell "Active"
      - gridcell "5"
      - gridcell "Seedyhappyprog"
      - gridcell:
        - button
        - button
    - row "Seedyhappyprog_10323 Seed batch Active 5 Seedyhappyprog":
      - gridcell:
        - checkbox
        - checkbox
      - gridcell "Seedyhappyprog_10323"
      - gridcell "Seed batch"
      - gridcell "Active"
      - gridcell "5"
      - gridcell "Seedyhappyprog"
      - gridcell:
        - button
        - button
- text: Showing 1 to 10 of 145 entries
- button "" [disabled]
- button "" [disabled]
- button "1"
- button "2"
...
- button ""
- button ""
- text: In total there are 145 batches.
```
