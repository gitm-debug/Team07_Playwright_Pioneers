...
- grid:
  ...
  - rowgroup:
    - row "azure-nnznjy_111 Active 5 azure-nnznjy":
      - gridcell:
        - checkbox
        - checkbox
      - gridcell "azure-nnznjy_111"
      - gridcell
      - gridcell "Active"
      - gridcell "5"
      - gridcell "azure-nnznjy"
      - gridcell:
        - button
        - button
    - row "SDET_12333 New generation1 Active 99 SDET":
      - gridcell:
        - checkbox
        - checkbox
      - gridcell "SDET_12333"
      - gridcell "New generation1"
      - gridcell "Active"
      - gridcell "99"
      - gridcell "SDET"
      - gridcell:
    ...
    - row "Seedyhappyprog_0056 Arrays and Loops Active 7 Seedyhappyprog":
      ...
      - gridcell:
        - button
        - button
    - row "Seedyhappyprog_10059 Seed batch Active 5 Seedyhappyprog":
      - gridcell:
        - checkbox
        - checkbox
      - gridcell "Seedyhappyprog_10059"
      - gridcell "Seed batch"
      - gridcell "Active"
      - gridcell "5"
      - gridcell "Seedyhappyprog"
    ...
    - row "Seedyhappyprog_10323 Seed batch Active 5 Seedyhappyprog":
      ...
      - gridcell:
        - button
        - button
    - row "Seedyhappyprog_10420 Seed batch Active 5 Seedyhappyprog":
      - gridcell:
        - checkbox
        - checkbox
      - gridcell "Seedyhappyprog_10420"
      - gridcell "Seed batch"
      - gridcell "Active"
      - gridcell "5"
      - gridcell "Seedyhappyprog"
      - gridcell:
        - button
        - button
    - row "Seedyhappyprog_11187 Seed batch Active 5 Seedyhappyprog":
      - gridcell:
        - checkbox
        - checkbox
      - gridcell "Seedyhappyprog_11187"
      - gridcell "Seed batch"
      - gridcell "Active"
      - gridcell "5"
      - gridcell "Seedyhappyprog"
      - gridcell:
        - button
        - button
    - row "Seedyhappyprog_11322 Seed batch Active 5 Seedyhappyprog":
      - gridcell:
        - checkbox
        - checkbox
      - gridcell "Seedyhappyprog_11322"
      - gridcell "Seed batch"
      - gridcell "Active"
      - gridcell "5"
      - gridcell "Seedyhappyprog"
      - gridcell:
        - button
        - button
    - row "Seedyhappyprog_11428 Seed batch Active 5 Seedyhappyprog":
      - gridcell:
        - checkbox
        - checkbox
      - gridcell "Seedyhappyprog_11428"
      - gridcell "Seed batch"
      - gridcell "Active"
      - gridcell "5"
      - gridcell "Seedyhappyprog"
      - gridcell:
        - button
        - button
- text: Showing 1 to 10 of 255 entries
- button "" [disabled]
- button "" [disabled]
- button "1"
- button "2"
...
- button ""
- button ""
- text: In total there are 255 batches.
```
