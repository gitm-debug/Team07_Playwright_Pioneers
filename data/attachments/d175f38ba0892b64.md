  ...
  - rowgroup:
    ...
    - row "Programlbabreep_26135 Active 5 Updatedagketd":
      ...
      - gridcell:
        - button
        - button
    - row "Programlbabreep_43193 Active 5 Updatedagketd":
      - gridcell:
        - checkbox
        - checkbox
      - gridcell "Programlbabreep_43193"
      - gridcell
      - gridcell "Active"
      - gridcell "5"
      - gridcell "Updatedagketd"
      - gridcell:
        - button
        - button
    - row "Programlbabreep_70625 Arrays and Loops Active 7 Updatedagketd":
      - gridcell:
        - checkbox
        - checkbox
      - gridcell "Programlbabreep_70625"
    ...
    - row "Programqbgpahmf_44777 Arrays and Loops Active 7 Updatedexsqmm":
      ...
      - gridcell:
        - button
        - button
- text: Showing 1 to 10 of 13 entries
- button "" [disabled]
- button "" [disabled]
- button "1"
- button "2"
- button ""
- button ""
- text: In total there are 13 batches.
```
