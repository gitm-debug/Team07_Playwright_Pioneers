  ...
  - rowgroup:
    - row "HBDDBrigade-BDD_024 Active 4 HBDDBrigade-BDD":
      ...
      - gridcell:
        - button
        - button
    - row "HBDDBrigade-BDD_987 Batch Description001 Active 4 HBDDBrigade-BDD":
      - gridcell:
        - checkbox
        - checkbox
    ...
    - row "TeamLMS_011 Active 4 Updatedhbhbvz":
      ...
      - gridcell:
        - button
        - button
    - row "TeamLMS_022 Active 4 Updatedhbhbvz":
      - gridcell:
        - checkbox
        - checkbox
      - gridcell "TeamLMS_022"
      - gridcell
      - gridcell "Active"
      - gridcell "4"
      - gridcell "Updatedhbhbvz"
    ...
    - row "TeamLMS_357 Batch Description001 Active 4 Updatedhbhbvz":
      ...
      - gridcell:
        - button
        - button
- text: Showing 1 to 10 of 19 entries
- button "" [disabled]
- button "" [disabled]
- button "1"
- button "2"
- button ""
- button ""
- text: In total there are 19 batches.
```
