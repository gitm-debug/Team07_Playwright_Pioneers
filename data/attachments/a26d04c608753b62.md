            ...
            - gridcell [ref=f1e54]:
              - generic [ref=f1e56] [cursor=pointer]:
                - generic [ref=f1e57]:
                  - checkbox
                - checkbox [ref=f1e58]
            - gridcell "TeamLMS_357" [ref=f1e59]
            ...
            - gridcell [ref=f1e235]:
              - generic [ref=f1e236]:
                ...
                - button [ref=f1e241] [cursor=pointer]:
                  - generic [ref=f1e242]: 
      - generic [ref=f1e244]:
        - generic [ref=f1e245] [cursor=pointer]: Showing 11 to 20 of 20 entries
        - button "" [ref=f1e246] [cursor=pointer]
        - button "" [ref=f1e248] [cursor=pointer]
        - generic [ref=f1e250]:
          - button "1" [ref=f1e251] [cursor=pointer]
          - button "2" [ref=f1e252] [cursor=pointer]
        - button "" [disabled]
        - button "" [disabled]
      - generic [ref=f1e253]: In total there are 20 batches.
```
